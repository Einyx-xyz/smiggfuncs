-- Lerp(s)
E2Helper.Descriptions["ordinal(n)"] = "Returns the ordinal of a number (e.g. 1 => 1st)"
E2Helper.Descriptions["timeFormat(n)"] = "Returns a nicely formatted number (e.g. 60 => 1:00)"
